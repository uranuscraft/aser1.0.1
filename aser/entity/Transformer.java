...
public abstract class Transformer extends TileEntityElectrical
	{
	    ...
	    public void recharge(ItemStack itemStack)
	    {
	        if (itemStack != null)
	        {
	            ...
	            else if (ModsManager.isTELoaded() && itemStack.getItem() instanceof IChargeableItem)
	            {

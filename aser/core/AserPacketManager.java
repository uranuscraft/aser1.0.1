...
public class AserPacketManager extends PacketManager implements IPacketHandler, IPacketReceiver {
	public enum AserPacketType
    {
        UNSPECIFIED,
        TILEENTITY,
        ENTITY;

        public static AserPacketType get(int id)
        {
            if (id >= 0 && id < PacketType.values().length)
            {
                return AserPacketType.values()[id];
            }
            return UNSPECIFIED;
        }
    }
    ...
    public static Packet getPacket(String channelName, Entity sender, ArrayList<Object> objs)
    {
        ...
        try
        {
            ...
            data = AserPacketManager.encodeDataStream(data, objs);
    ...
    public static Packet getPacket(String channelName, Entity sender, Object... sendData)
    {
        ...
        try
        {
            ...
            data.writeInt(sender.entityId);
            data = AserPacketManager.encodeDataStream(data, sendData);
